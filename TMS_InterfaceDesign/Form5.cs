...
namespace TMS_InterfaceDesign
{
    public partial class Form5 : Form
    {
        ...
        {
            int freeAppartments = 0;
            string buildingA = "A";
            string buildingB = "B";
            string buildingC = "C";
            string sqlStatement = "select building_name,freeAppartments from building where building_name=" + "'" + buildingB + "'";
            SqlCommand cmd = new SqlCommand(sqlStatement, con);
            con.Open();
            var resultset = cmd.ExecuteReader();
            while (resultset.Read())
            {
                freeAppartments = int.Parse(resultset.GetValue(1).ToString());
            
                bunifuGauge2.Value = 100 - freeAppartments;
        ...
        private void bunifuThinButton24_Click(object sender, EventArgs e)
        {
            ...
            string buildingB = "B";
            string buildingC = "C";
            string sqlStatement = "select building_name,freeAppartments from building where building_name=" + "'" + buildingA + "'";
            SqlCommand cmd = new SqlCommand(sqlStatement, con);
            con.Open();
            var resultset = cmd.ExecuteReader();
            while (resultset.Read())
            {
                ...
                bunifuGauge1.Value = 100 - freeAppartments;
        ...
        private void bunifuThinButton26_Click(object sender, EventArgs e)
        {
            ...
            string buildingB = "B";
            string buildingC = "C";
            string sqlStatement = "select building_name,freeAppartments from building where building_name=" + "'" + buildingC + "'";
            SqlCommand cmd = new SqlCommand(sqlStatement, con);
            con.Open();
            var resultset = cmd.ExecuteReader();
            while (resultset.Read())
            {
                ...
                bunifuGauge3.Value = 100 - freeAppartments;
